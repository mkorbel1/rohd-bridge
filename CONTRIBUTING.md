# Contributing to ROHD Bridge

Thank you for considering contributing to ROHD Bridge! Contributions from the community are vital to making this a successful project.

Anyone interested in participating in ROHD Bridge is more than welcome to help!

## Code of Conduct

ROHD Bridge adopts the [Contributor Covenant](https://www.contributor-covenant.org/) v2.1 for the code of conduct. It can be accessed at the [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md).
...
You can access the discussions area here: <https://github.com/intel/rohd-bridge/discussions>
...
You can file an issue here: <https://github.com/intel/rohd-bridge/issues/new/choose>

### Stack Overflow

[Stack Overflow](https://stackoverflow.com/) is a great tool to ask questions and get answers from the community. Use the `rohd` and/or `rohd-bridge` tag when asking your question so that others in the community who subscribe to that tag can find and answer your question more quickly!
...
You must have [Dart](https://dart.dev/) installed on your system to use ROHD and ROHD Bridge. You can find detailed instructions for how to install Dart here:
...
[GitHub Codespaces](https://github.com/features/codespaces) are a great feature provided by GitHub allowing you to get into a development environment based on a pre-configured container very quickly! You can use them for a limited number of hours per month for free. ROHD Bridge has set up GitHub Codespaces so that you can immediately start running examples and developing.

The below button will allow you to create a GitHub Codespace with ROHD Bridge already cloned and ready to roll:
...
```shell
git clone https://github.com/intel/rohd-bridge.git
cd rohd-bridge
dart pub get
dart test
```
...
* The version of ROHD and ROHD Bridge you're using
...
//
// example.dart
// A very basic example of some connections.
//
// 2024 September 17
...
Not every new contribution has to go directly into the ROHD or ROHD Bridge frameworks! If you have an idea for a reusable piece of hardware, tooling, verification collateral, or anything else that helps the ROHD ecosystem but is somewhat standalone, you can make your own package that depends on ROHD. Building an ecosystem of reusable components is important to the success of ROHD. Reach out if you want some help or guidance deciding if or how you should create a new package.

## Style

Like ROHD, ROHD Bridge follows the official Dart recommended style guides and lints. The analyzer will help ensure that your code is written consistently with the rest of ROHD.
